...
cmp.setup {
  ...
  mapping = cmp.mapping.preset.insert({
    ...
    ['<CR>'] = cmp.mapping.confirm({ select = XotoVimGlobal.plugins.completion.select_first_on_enter }),
  ...
  window = {
    completion = cmp.config.window.bordered({ winhighlight = "NormalFloat:NormalFloat,FloatBorder:FloatBorder" }),
