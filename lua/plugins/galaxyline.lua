...
-- local galaxy_section = galaxyline.section
...
-- -- --> needs work
-- index = 1
-- galaxy_section.short_line_left[index] = {
--   BufferType = {
...
-- index = index + 1
-- galaxy_section.short_line_right[index] = {
--   BufferIcon = {
--     highlight = { colors.fg, colors.bg_statusline },
--     provider = "BufferIcon",
--   },
